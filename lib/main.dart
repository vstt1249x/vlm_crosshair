            ...
            children: [
              ...
              if (imageUrl.isNotEmpty)
                ...
                Container(
                  ...
                  child: const Icon(Icons.gps_fixed, size: 64, color: Colors.redAccent),
                ),
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: imageUrl.isNotEmpty
                                        ...
                                        : const Icon(Icons.gps_fixed, size: 60, color: Colors.redAccent),
                                  ),
                                  const SizedBox(width: 12),
                                  Expanded(
                                    child: Column(
                          ...
                          children: [
                            ...
                            ClipRRect(
                              ...
                              child: imageUrl.isNotEmpty
                                  ...
                                  : const Icon(Icons.gps_fixed, size: 50, color: Colors.redAccent),
                            ),
                            const SizedBox(width: 12),
                            Expanded(
                              child: Column(
